...
class UserGetApi(object):
    ...
    def user_access_code_validate_access_code(self, **kwargs):  # noqa: E501
        """Validates the AccessCode  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.user_access_code_validate_access_code(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str accesscode:
        :return: None
        ...
        if kwargs.get('async_req'):
            return self.user_access_code_validate_access_code_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.user_access_code_validate_access_code_with_http_info(**kwargs)  # noqa: E501
            return data

    def user_access_code_validate_access_code_with_http_info(self, **kwargs):  # noqa: E501
        """Validates the AccessCode  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.user_access_code_validate_access_code_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['accesscode']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method user_access_code_validate_access_code" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if 'accesscode' in params:
            query_params.append(('accesscode', params['accesscode']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v3/user/accesscode/verification', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def user_get(self, **kwargs):  # noqa: E501
        ...
        :return: SaveTVWebApiResponseModelsUser
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def user_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='SaveTVWebApiResponseModelsUser',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
